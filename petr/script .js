...
const lastFavoriteMovie = prompt('Один из последних просмотренных фильмов?');
const rating = prompt('На сколько оцените его?');
const lastFavoriteMovie1 = prompt('Один из последних просмотренных фильмов?');
const rating1 = prompt('На сколько оцените его?');

personalMovieDB.movies[lastFavoriteMovie] = rating;
personalMovieDB.movies[lastFavoriteMovie1] = rating1;
